namespace IronOreSilicaPercent
{
    ...
    class Program
    {
        ...
        static readonly RetryStrategy TransientRetryStrategy =
            new IronOreSilicaPercent.ExponentialBackoff(RetryCount, TimeSpan.FromSeconds(2), TimeSpan.FromSeconds(60), TimeSpan.FromSeconds(4));
            ...
            CancellationTokenSource cts)
        {
            ...
            {
                string dataBuffer = IronOreSilicaPercent.SimulatedIronOreInputs.GenerateSimulatedIronOreData();
                var eventMessage = new Message(Encoding.UTF8.GetBytes(dataBuffer));
                await moduleClient.SendEventAsync("IronOreMeasures", eventMessage);
