...
Where Group_id in (select group_id from sys.availability_groups where name = 'AutoFailoverFailure')

-- sp_readerrorlog 0,1, '89959CFD-4DCC-4286-BC1D-2F3EA8F546A8'
...
Where drs.is_local = 1 and ag.name = 'AutoFailoverFailure'
Go
